...
{{
  ...
  "conclusion_tag": "<OS_INITIATED|RF_INTERFERENCE|AP_KICK|FIRMWARE_CRASH|MCC_MISMATCH|DRIVER_INIT_FAILURE|AUTH_FAILURE|ASSOC_FAILURE|HANDSHAKE_FAILURE|WAKE_RESUME_DELAY|BIOS_CONFIG_ISSUE|ROAMING_DECISION|SOFTAP_START_FAILURE|P2P_CONNECT_FAILURE|OTHER>",
