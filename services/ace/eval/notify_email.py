...
Environment variables:
  ACE_NOTIFY_TO         Required for automatic notify. Comma/semicolon list.
  ACE_NOTIFY_CC         Optional comma/semicolon list.
...
def notify_from_env(*, namespace: str, review_report: dict, triage_report: dict | None) -> bool:
    ...
    """
    to_list = _parse_recipients(os.getenv("ACE_NOTIFY_TO"))
    if not to_list:
        return False

    cc_list = _parse_recipients(os.getenv("ACE_NOTIFY_CC"))
